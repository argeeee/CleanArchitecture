...
/// <summary>
/// An Autofac module responsible for wiring up services defined in Data.
...
public class AutofacDataModule : Module {
  ...
  private void LoadAssemblies() {
    ...
    var coreAssembly = Assembly.GetAssembly(typeof(Config));
    // var domainAssembly = Assembly.GetAssembly(typeof(Entity));
    var infrastructureAssembly = Assembly.GetAssembly(typeof(AutofacDataModule));

    AddToAssembliesIfNotNull(coreAssembly);
    // AddToAssembliesIfNotNull(domainAssembly);
